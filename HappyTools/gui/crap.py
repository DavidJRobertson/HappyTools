...
import HappyTools
from util import batchFunctions
...
def batch_popup():
    ...
    ToolTip(outputButton, "This button will open another window in which you can select which outputs you want " +
